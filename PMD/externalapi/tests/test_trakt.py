...
from PMD.externalapi.trakt import Trakt
...
class TestTraktApi(TestCase):
    ...
    def test_should_find_exact_movie(self):
        ...
        self.assertTrue(self.api.query(query=data['title'], year=data['year'], media=data['type']) is not None)
    ...
    def test_should_not_find_movie(self):
        ...
        self.assertTrue(self.api.query(query=data['title'], year=data['year'], media=data['type']) is None)
